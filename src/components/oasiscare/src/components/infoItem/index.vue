<template>
  <div class="infoItem">
    <!-- <div class="keyBox" :style="[compKeyW, compAlign]" v-if="['space-between', 'space-around'].indexOf(keyAlign) > -1">
      <span class="space-between" v-if="keyAlign === 'space-between'" v-for="(item, index) in keys" :key="index" v-html="item"></span>
      <span class="space-around" v-if="keyAlign === 'space-around'" v-for="(item, index) in keys" :key="index" v-html="item"></span>
    </div> -->
    ...
    <div class="keyBox" :style="[compKeyW]" v-if="['left', 'center', 'right'].indexOf(keyAlign) > -1">
      <span class="keyBoxItem" :style="[compAlign]" v-html="keyItem"></span>
    </div>
    <div class="valueBox">
